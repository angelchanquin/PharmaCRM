...
describe('Service Tests', () => {
    ...
    describe('OrdenDeCompra Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OrdenDeCompraService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/orden-de-compras';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OrdenDeCompra', () => {

                let entity: OrdenDeCompra;
                service.find(123).subscribe((_entity: OrdenDeCompra) => {
                    entity = _entity;
                });
