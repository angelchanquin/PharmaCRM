...
describe('Service Tests', () => {
    ...
    describe('DetalleDeCompra Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DetalleDeCompraService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/detalle-de-compras';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DetalleDeCompra', () => {

                let entity: DetalleDeCompra;
                service.find(123).subscribe((_entity: DetalleDeCompra) => {
                    entity = _entity;
                });
