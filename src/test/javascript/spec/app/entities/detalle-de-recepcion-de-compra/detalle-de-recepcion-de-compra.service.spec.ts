...
describe('Service Tests', () => {
    ...
    describe('DetalleDeRecepcionDeCompra Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DetalleDeRecepcionDeCompraService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/detalle-de-recepcion-de-compras';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DetalleDeRecepcionDeCompra', () => {

                let entity: DetalleDeRecepcionDeCompra;
                service.find(123).subscribe((_entity: DetalleDeRecepcionDeCompra) => {
                    entity = _entity;
                });
