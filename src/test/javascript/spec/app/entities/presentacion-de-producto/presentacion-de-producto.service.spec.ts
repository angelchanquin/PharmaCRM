...
describe('Service Tests', () => {
    ...
    describe('PresentacionDeProducto Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PresentacionDeProductoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/presentacion-de-productos';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PresentacionDeProducto', () => {

                let entity: PresentacionDeProducto;
                service.find(123).subscribe((_entity: PresentacionDeProducto) => {
                    entity = _entity;
                });
