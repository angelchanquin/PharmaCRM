...
describe('Service Tests', () => {
    ...
    describe('RecepcionDeCompra Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RecepcionDeCompraService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/recepcion-de-compras';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RecepcionDeCompra', () => {

                let entity: RecepcionDeCompra;
                service.find(123).subscribe((_entity: RecepcionDeCompra) => {
                    entity = _entity;
                });
